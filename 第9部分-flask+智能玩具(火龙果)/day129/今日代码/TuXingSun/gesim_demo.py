...
def my_plus(a):
    ...
    #[[(1,1),(4,1),(2,1),(3,1),(0,1)] , [(1,1),(6,1),(7,1),(5,1)]]
    # 165 - 1675
    print(all_doc_list)
    
    doc_test_list = [word for word in jieba.cut(a)] # ['你', '今年', '多大', '了']
    #[(1,1),(6,1),(5,1)]
    #[(1, 1), (5, 1), (6, 1)]
    print(doc_test_list)
    ...
    if cc[0][1] > 0:
        ...
        c = MONGO_DB.content.find_one({"title":text})
        return c
